            ...
            <div className='py-5' style={{backgroundColor: "#FFFFFF"}}>
                ...
                <div className='container-fluid'>
                    <div className='row py-5'>
                        <div className='col-md-4'>
                            <div className='d-flex align-items-center justify-content-center pb-3'><img
                                src='https://lifesum.com/media/usp-diets-45675b0b.svg' alt='diet'/></div>
                        ...
                        <div className='col-md-4'>
                            <div className='d-flex align-items-center justify-content-center pb-3'><img
                                src='https://lifesum.com/media/usp-mealplans-13b2e368.svg' alt='diet'/></div>
                        ...
                        <div className='col-md-4'>
                            <div className='d-flex align-items-center justify-content-center pb-3'><img
                                src='https://lifesum.com/media/usp-recipes-23c9a7b7.svg' alt='diet'/></div>
                    ...
                    <div className='row py-5'>
                        <div className='col-md-4'>
                            <div className='d-flex align-items-center justify-content-center pb-3'><img
                                src='https://lifesum.com/media/usp-barcode-e826085a.svg' alt='diet'/></div>
                        ...
                        <div className='col-md-4'>
                            <div className='d-flex align-items-center justify-content-center pb-3'><img
                                src='https://lifesum.com/media/usp-trackers-d12fa952.svg' alt='diet'/></div>
                        ...
                        <div className='col-md-4'>
                            <div className='d-flex align-items-center justify-content-center pb-3'><img
                                src='https://lifesum.com/media/usp-personalize-1efee572.svg' alt='diet'/></div>
                ...
                <div className='text-center mb-48 lg:mb-64'>
                    <button type='button' className='btn btn-light'
                            ...
                            onClick={() => {
                                navigate(isAuthenticated ? ('/features') : "");
                            }}
