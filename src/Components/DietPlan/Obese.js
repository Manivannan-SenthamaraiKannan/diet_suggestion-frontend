                ...
                <div className='diets'>
                    ...
                    <div className="card" style={{ width: "18rem" }}>
                        <div className="card-body">
                            ...
                            <Link to="/fasting" className="btn btn-primary"
                    ...
                    <div className="card" style={{ width: "18rem" }}>
                        <div className="card-body">
                            ...
                            <Link to="/gluten" className="btn btn-primary"
                    ...
                    <div className="card" style={{ width: "18rem" }}>
                        <div className="card-body">
                            ...
                            <Link to="/lowfat" className="btn btn-primary"
                    ...
                    <div className="card" style={{ width: "18rem" }}>
                        <div className="card-body">
                            ...
                            <Link to="/rawfood" className="btn btn-primary"
                    ...
                    <div className="card" style={{ width: "18rem" }}>
                        <div className="card-body">
                            ...
                            <Link to="/paleolithic" className="btn btn-primary"
                    ...
                    <div className="card" style={{ width: "18rem" }}>
                        <div className="card-body">
                            ...
                            <Link to="/lowcalorie" className="btn btn-primary"
                    ...
                    <div className="card" style={{ width: "18rem" }}>
                        <div className="card-body">
                            ...
                            <Link to="/south" className="btn btn-primary"
                    ...
                    <div className="card" style={{ width: "18rem" }}>
                        <div className="card-body">
                            ...
                            <Link to="/atkins" className="btn btn-primary"
                    ...
                    <div className="card" style={{ width: "18rem" }}>
                        <div className="card-body">
                            ...
                            <Link to="/vegetarianism" className="btn btn-primary"
                    ...
                    <div className="card" style={{ width: "18rem" }}>
                        <div className="card-body">
                            ...
                            <Link to="/whole30" className="btn btn-primary"
                    ...
                    <div className="card" style={{ width: "18rem" }}>
                        <div className="card-body">
                            ...
                            <Link to="/slimfast" className="btn btn-primary"
